package com.example.mediacodecsample;
...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    private static final String SAMPLE = Environment.getExternalStorageDirectory() + "/gangganghao.mp4";
    private static final String TAG = "MC_Sample";
    ...
    private class WorkThread extends Thread {
        ...
        public void run() {
            ...
            Log.e(TAG, " mMediaExtractor.getTrackCount() = " +  mMediaExtractor.getTrackCount());
            for (int i = 0; i < mMediaExtractor.getTrackCount(); i++) {//遍历数据源音视频轨迹
                MediaFormat format = mMediaExtractor.getTrackFormat(i);
                Log.e(TAG, ">> format i " + i + ": " +  format);
